            ...
            <div class="col-md-9">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8 col-lg-8 col-md-8">
                        <div class="thumbnail">
                            <a href="pizzahutpage.html"><img src="mum_rest1.jpg" style="width:640px; height:300px;"></a>
                            <div class="caption">
                            
                                <b><p>Mumbai CST Area   ·  Casual Dining<br>
								Phone Number: 022123456<br>
								Table booking recommended.<br>
								Opening hours:11am to 11pm.   Home Delivery available.<br></b>
								<form class="form-group" action="orderfoodpage.php">
								<input type="submit" value="Click here to Order food">
								</form>
...
<h2>Write A feedback</h2>
		...
		<input type="hidden" name="id" value="1">
          <p>
            <input type="text" name="name" id="name" value="" size="22" autofocus required</>
